# LOSD Implementation Specification
...
Extend the current skill decomposition pipeline based on **zero-shot (ZS)**, **few-shot (FS)**, and **RAG** prompting with a **post-generation neuro-symbolic refinement layer** suitable for a LOSD paper release.

The LOSD extension should add non-trivial new material through:
...
The LOSD paper should **extend** this pipeline rather than replace it.
...
## 13. Experiments for the LOSD paper
...
This is the main experiment showing the added value of LOSD.
...
Add these subsections to the LOSD version:
